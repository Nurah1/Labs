...
public class Lab7 {
	...
	public static void main(String[] args) {
		...
		String[] name = new String[] { "Nadia", "Kyle", "Adam", "Mumeen", "Jason", };
				
		}
		String[] hometown = new String[] { "Royal Oak", "Detroit", "West Bloomfield", "Detroit", "Detroit",};
				
		String[] favoriteFood = new String[] { "Chocolate", "Turkey Burgers", " Pizza", "Potato", "Pizza",};
		...
		while (choice.equals("y")) {
			...
			try {
				...
				System.out.println("You have entered an invalid number.  Please choose from 1-5.");
				continue;
			} catch (InputMismatchException ex) {
				System.out.println("You have entered an invalid response.  Please choose a number from 1-5.");
				scanner.next();
				continue;
			}
			scanner.nextLine();
